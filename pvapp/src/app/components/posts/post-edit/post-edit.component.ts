...
export class PostEditComponent implements OnInit {
    ...
    this.route.params.subscribe(data => {
      ...
      this.postService.getDetails(this.id).subscribe(data => {
        ...
        this.postEditForm = this.fb.group({
          title: [this.post.title, [Validators.required, Validators.minLength(3), Validators.maxLength(30)]],
          authorId:[this.post.authorId,[Validators.required]],
          author: [this.post.author, [Validators.required, Validators.minLength(3), Validators.maxLength(30)]],
          content: [this.post.content, [Validators.required, Validators.minLength(10), Validators.maxLength(5000)]],
  ...
  get authorId() { return this.postEditForm.get('authorId'); }
